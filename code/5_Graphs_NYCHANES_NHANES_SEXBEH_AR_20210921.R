...
# Subset number of partners variables
...
setwd("C:/Users/rivera30/OneDrive - NYU Langone Health/NYC Sexual Behavior/Ariadne/SexBeh_repo/results/Graphs/Gender")

#Subset lifetime prev variables by gender
gender <- subset(ever_all, cat == "gender")

# Factor for easier graphing and name the levels so that this is how it appears 
# in the legend with ggplot
...
#This is to add all the panels by group in one
...
###########################
# Anal sex partners, only available in NYC
...
setwd("C:/Users/rivera30/OneDrive - NYU Langone Health/NYC Sexual Behavior/Ariadne/SexBeh_repo/results/Graphs/Age")
...
setwd("C:/Users/rivera30/OneDrive - NYU Langone Health/NYC Sexual Behavior/Ariadne/SexBeh_repo/results/Graphs/Race_Ethnicity")
...
#Set working directory to save plots
setwd("C:/Users/rivera30/OneDrive - NYU Langone Health/NYC Sexual Behavior/Ariadne/SexBeh_repo/results/Graphs/BMI")
